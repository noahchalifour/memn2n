...
HP_EMBED_SIZE = hp.HParam('embedding_size', hp.Discrete([32]))

HP_MEMORY_SIZE = hp.HParam('memory_size', hp.Discrete([50]))
HP_MEMORY_HOPS = hp.HParam('memory_hops', hp.Discrete([3]))
